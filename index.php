...
<body>
	...
	<form method="POST" action="../user/welcome.php" name="user_login">
		...
		Username/ Email:<br>
		<input type="text" name="user_email" placeholder="Email-ID" style="height:20px; width: 170px; border-radius: 6px;" required /><br>
		Password: <br>
		<input type="password" name="user_password" placeholder="*****" style="height:20px; width: 170px; border-radius: 6px;" required /><br>
