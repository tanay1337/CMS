<!DOCTYPE HTML>
<head>
	<title>Complaint Management System - Registered</title>
...
Sorry, there was an error registering you into KAG's CMS. You will need an unique Email-Id to register into CMS. The details have been stated below.<br><br> <center>The Email-Id <?php echo $email; ?>, has already been taken.</center>
</div>
<?php
}
mysqli_close($con);
