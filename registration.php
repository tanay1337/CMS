...
<body>
	...
	<form name="registration" id="registration" method="POST" action="registered.php">
			...
			<input type="text" name="lastname" placeholder="Last Name" style="height:25px; width: 190px; border-radius: 6px;" required /><br><br>
			<input type="email" name="email" placeholder="Your Email" style="height:25px; width: 385px; border-radius: 6px;" required /><br><br>
  ...
  <option value="B6">B6</option>
			...
			<input type="text" name="flatnumber" placeholder="Flat Number" style="height:25px; width: 265px; border-radius: 6px;" required /><br><br>
			<input type="text" name="mobile" placeholder="Mobile Number" style="height:25px; width: 385px; border-radius: 6px;" required /><br><br>
			<input type="password" name="password" placeholder="New Password" style="height:25px; width: 385px; border-radius: 6px;" required /><br><br>
			
			
<span style="color: grey; font-size: 10px;">By clicking Sign Up, you agree to our Terms and that you <br>have read our Data Use Policy, including our Cookie Use.</span><br><br>		
...
<div id="footer_left" style="color: #ffffff; float: center; width: 70%; margin-left: 10%; font-family: 'Arimo', sans-serif;">
			<font size="2px">Copyright © 2014 Tanay Pant. All rights reserved.</font>
		</div>
</div>
</body>
